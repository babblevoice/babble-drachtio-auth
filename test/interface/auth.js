...
describe( "sipauth", function() {
  ...
  it( "parseauthheaders sets values correctly", async function() {
    ...
    const digest = "89eb0059246c02b2f6ee02c7961d5ea3"
...
opaque="${a._opaque}"`
    ...
    const params = a.parseauthheaders( req )
  ...
  it( "3.1 example", async function() {
    ...
    const cnonce = "0a4f113b"
    const method = "INVITE"
    const digest = "bf57e4e0d0bffc0fbaedce64d59add5e"
    const nc = "00000001"
...
opaque="${a._opaque}"`
    ...
    const authobj = a.parseauthheaders( req )
  ...
  it( "repeat cnonce check", async function() {
    const client = new sipauth()
    const server = new sipauth()
    ...
    const authentication = client.parseauthheaders( req )
  ...
  it( "sipp auth test - captured", async function() {
    ...
    const server = new sipauth( false )
    const auth = server.parseauthheaders( req )
